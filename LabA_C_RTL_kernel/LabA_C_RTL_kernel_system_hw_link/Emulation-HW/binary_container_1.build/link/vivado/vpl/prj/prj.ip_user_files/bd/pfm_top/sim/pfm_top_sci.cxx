...
void pfm_top_sci::before_end_of_elaboration() {
	...
	pfm_top_xbar_0_sc*  inst_48=dynamic_cast<pfm_top_xbar_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_xbar_0"));
	...
	if (inst_48!=NULL && inst_49!=NULL && inst_49->getTlmSocketByName("BLP_S_AXI_CTRL_USER_00_tlm_aximm_read_socket")!=NULL) {
		inst_48->initiator_0_rd_socket->bind(*static_cast<xtlm::xtlm_aximm_target_socket*>(inst_49->getTlmSocketByName("BLP_S_AXI_CTRL_USER_00_tlm_aximm_read_socket")));
	}
	
	pfm_top_xbar_0_sc*  inst_52=dynamic_cast<pfm_top_xbar_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_xbar_0"));
	...
	if (inst_52!=NULL && inst_53!=NULL && inst_53->getTlmSocketByName("BLP_S_AXI_CTRL_USER_00_tlm_aximm_write_socket")!=NULL) {
		inst_52->initiator_0_wr_socket->bind(*static_cast<xtlm::xtlm_aximm_target_socket*>(inst_53->getTlmSocketByName("BLP_S_AXI_CTRL_USER_00_tlm_aximm_write_socket")));
	}
	
	pfm_top_sim_qdma_0_0_sc*  inst_56=dynamic_cast<pfm_top_sim_qdma_0_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_sim_qdma_0_0"));
	pfm_top_xbar_0_sc*  inst_57=dynamic_cast<pfm_top_xbar_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_xbar_0"));
	xtlm_aximm_transaction_logger* log_inst_7 = new xtlm_aximm_transaction_logger("xtlm_aximm_transaction_logger_7");
	log_inst_7->setProxyRef(inst_56, inst_57, "pfm_top_sim_qdma_0_0_M_AXICTRL_TLM", "pfm_top_xbar_0_S00_AXI_TLM", log_inst_7->m_transactionLogger);
	...
	if (inst_56!=NULL && inst_57!=NULL) {
		inst_56->initiator_ctrl_rd_socket->bind(*(log_inst_7->tar_rd_skt));
		log_inst_7->init_rd_skt->bind(*(inst_57->target_0_rd_socket));
	}
	
	pfm_top_sim_qdma_0_0_sc*  inst_60=dynamic_cast<pfm_top_sim_qdma_0_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_sim_qdma_0_0"));
	pfm_top_xbar_0_sc*  inst_61=dynamic_cast<pfm_top_xbar_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_xbar_0"));
	...
	if (inst_60!=NULL && inst_61!=NULL) {
		inst_60->initiator_ctrl_wr_socket->bind(*(log_inst_7->tar_wr_skt));
	...
	pfm_top_embedded_schedular_0_sc*  inst_73=dynamic_cast<pfm_top_embedded_schedular_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_embedded_schedular_0"));
	xtlm_aximm_transaction_logger* log_inst_9 = new xtlm_aximm_transaction_logger("xtlm_aximm_transaction_logger_9");
	log_inst_9->setProxyRef(inst_72, inst_73, "pfm_top_xbar_0_M02_AXI_TLM", "pfm_top_embedded_schedular_0_s_axi_ctrl_user_TLM", log_inst_9->m_transactionLogger);
	...
	if (inst_72!=NULL && inst_73!=NULL) {
		inst_72->initiator_2_rd_socket->bind(*(log_inst_9->tar_rd_skt));
		log_inst_9->init_rd_skt->bind(*(inst_73->s_axi_ctrl_user_rd_socket));
	}
	
	pfm_top_xbar_0_sc*  inst_76=dynamic_cast<pfm_top_xbar_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_xbar_0"));
	pfm_top_embedded_schedular_0_sc*  inst_77=dynamic_cast<pfm_top_embedded_schedular_0_sc*>(xsc::utils::xsc_sim_manager::getInstancePtr("pfm_top_embedded_schedular_0"));
	...
	if (inst_76!=NULL && inst_77!=NULL) {
		inst_76->initiator_2_wr_socket->bind(*(log_inst_9->tar_wr_skt));
		log_inst_9->init_wr_skt->bind(*(inst_77->s_axi_ctrl_user_wr_socket));
	}
