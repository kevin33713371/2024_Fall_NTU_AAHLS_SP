...
extern "C" void krnl_vadd(int*, int*, int, int, int, int);
extern "C" void apatb_krnl_vadd_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c, int __xlx_apatb_param_n_elements) {
  // Collect __xlx_a_b__tmp_vec
  vector<sc_bv<32> >__xlx_a_b__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    ...
    __xlx_a_b__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  int* __xlx_a_b__input_buffer= new int[__xlx_a_b__tmp_vec.size()];
  for (int i = 0; i < __xlx_a_b__tmp_vec.size(); ++i) {
    __xlx_a_b__input_buffer[i] = __xlx_a_b__tmp_vec[i].range(31, 0).to_uint64();
  }
  ...
  // DUT call
  krnl_vadd(__xlx_a_b__input_buffer, __xlx_c__input_buffer, __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_apatb_param_n_elements);
// print __xlx_apatb_param_a
  ...
  for (int i = 0; i < __xlx_size_param_a; ++i) {
    __xlx_a_output_buffer[i] = __xlx_a_b__input_buffer[i+__xlx_offset_param_a];
  }
  for (int i = 0; i < __xlx_size_param_a; ++i) {
...
// print __xlx_apatb_param_b
  ...
  for (int i = 0; i < __xlx_size_param_b; ++i) {
    __xlx_b_output_buffer[i] = __xlx_a_b__input_buffer[i+__xlx_offset_param_b];
  }
  for (int i = 0; i < __xlx_size_param_b; ++i) {
