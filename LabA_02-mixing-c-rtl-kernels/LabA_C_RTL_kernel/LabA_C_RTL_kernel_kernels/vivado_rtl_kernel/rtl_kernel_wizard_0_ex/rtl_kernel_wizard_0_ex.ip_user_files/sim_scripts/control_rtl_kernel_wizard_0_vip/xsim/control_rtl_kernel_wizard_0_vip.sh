...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_12 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot control_rtl_kernel_wizard_0_vip xil_defaultlib.control_rtl_kernel_wizard_0_vip xil_defaultlib.glbl -log elaborate.log
}
