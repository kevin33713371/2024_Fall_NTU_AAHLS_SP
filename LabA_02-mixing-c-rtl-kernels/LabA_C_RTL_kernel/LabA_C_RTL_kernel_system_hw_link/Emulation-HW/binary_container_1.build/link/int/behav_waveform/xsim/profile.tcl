...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_u50_gen3x16_xdma_5_202210_1-0
...
# Compute Unit Ports
#
set computeUnits { krnl_vadd_1 krnl_vadd_1 }
set cuFullPaths      { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/inst/ /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/inst/ }
set ports { m_axi_gmem m_axi_gmem1 }
set readBusySignals { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/m_axi_gmem.readActive /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/m_axi_gmem1.readActive }
set writeBusySignals { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/m_axi_gmem.writeActive /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/krnl_vadd_1/m_axi_gmem1.writeActive }
