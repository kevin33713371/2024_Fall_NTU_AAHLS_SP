...
#---------------------------
# Platform Parameters for xilinx_u50_gen3x16_xdma_5_202210_1
#---------------------------
...
#---------------------------
# Instantiating rtl_kernel_wizard_0_1
#---------------------------
set rtl_kernel_wizard_0_1 [create_bd_cell -type ip -vlnv mycompany.com:kernel:rtl_kernel_wizard_0:1.0 rtl_kernel_wizard_0_1]
...
#---------------------------
connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /slr0/interconnect_axilite_user_0/M02_AXI] \
  [get_bd_intf_pins -auto_enable /krnl_vadd_1/s_axi_control] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /slr0/interconnect_axilite_user_0/M03_AXI] \
  [get_bd_intf_pins -auto_enable /rtl_kernel_wizard_0_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /krnl_vadd_1/ap_clk] \
  [get_bd_pins -auto_enable /rtl_kernel_wizard_0_1/ap_clk] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M02_ACLK] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M03_ACLK] \

connect_bd_net  \
  [get_bd_pins -auto_enable /psr_kernel_clk_0/interconnect_aresetn] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M02_ARESETN] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M03_ARESETN] \
...
connect_bd_net  \
  [get_bd_pins -auto_enable /rtl_kernel_wizard_0_1/interrupt] \
...
hbm_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /krnl_vadd_1/m_axi_gmem1] \
  [get_bd_cells /hmss_0] [list HBM_MEM00]

hbm_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /rtl_kernel_wizard_0_1/m00_axi] \
  [get_bd_cells /hmss_0] [list HBM_MEM00]
